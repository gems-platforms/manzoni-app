...
export function MistralIcon({width = "100px", height = "100px"}: MistralIconProps) {
    return (
        <svg
            viewBox="0 0 512 512"
        ...
        >
            ...
            />
            <path
                d="M378.07 303.228h-94.495l.044-94.446h94.498l-.047 94.446z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M189.128 208.779H94.633l.044-94.448h94.498l-.047 94.448z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M378.115 208.779h-94.494l.045-94.448h94.496l-.047 94.448z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M94.587 303.227H.093l.044-96.017h94.496l-.046 96.017z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
            ...
            />
            <path
                d="M94.68 115.902H.185L.23 19.885h94.498l-.047 96.017z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M472.657 114.331h-94.495l.044-94.446h94.497l-.046 94.446z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M94.54 399.244H.046l.044-97.588h94.497l-.047 97.588z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M94.495 492.123H0l.044-94.446H94.54l-.045 94.446z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M472.563 303.228H378.07l.044-94.446h94.496l-.047 94.446z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
                d="M472.61 208.779h-94.495l.044-94.448h94.498l-.047 94.448z"
                fill="#1c1c1b"
                fillRule="nonzero"
            />
            <path
            ...
            />
            <path
                d="M228.423 208.77H132.36l.045-94.445h96.066l-.05 94.446z"
                fill="#ffa300"
                fillRule="nonzero"
            />
            <path
                d="M418.985 208.77H322.92l.044-94.445h96.069l-.048 94.446z"
                fill="#ffa300"
                fillRule="nonzero"
            />
            <path
            ...
            />
            <path
                d="M133.976 114.325H39.484l.044-94.448h94.497l-.05 94.448z"
                fill="#ffce00"
                fillRule="nonzero"
            />
            <path
                d="M511.954 115.325h-94.493l.044-95.448h94.497l-.048 95.448z"
                fill="#ffce00"
                fillRule="nonzero"
            />
            <path
